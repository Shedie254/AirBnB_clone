#!/usr/bin/python3
"""Defines a console for managing HolbertonBnB instances."""
import cmd
import re
...
class HBNBCommand(cmd.Cmd):
    """Implements a command interpreter for HolbertonBnB.
    ...
    def default(self, arg):
        """Handles default behavior for an invalid cmd input."""
        argdict = {
            "all": self.do_all,
            "show": self.do_show,
